<div x-data="{showModal :false }">
    <button @click="showModal =! showModal"
        class="bg-white hover:bg-gray-100 text-gray-500 font-semibold p-1  border border-1">
    ...
    <button type="button" class="bg-white hover:bg-gray-100 text-gray-500 font-semibold p-1  border "><svg xmlns="http://www.w3.org/2000/svg" fill="none"
        viewBox="0 0 24 24" stroke-width="1.5" wire:click="deleteRecipe({{$this->recipe_id}})" stroke="currentColor" class="w-5 h-5">
